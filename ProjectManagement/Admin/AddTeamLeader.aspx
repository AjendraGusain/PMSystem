                                ...
                                <div class="card-body">
                                    <section class="body current">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-6">
                                                <asp:ListBox ID="lsTeamLeader" runat="server" data-live-search="true" SelectionMode="Multiple" CssClass="form-control js-example-placeholder-single"></asp:ListBox>
